...
ips = [
    "172.16.18.2", #funcionando
    #"172.16.24.15", # desligada do psi
    "172.16.17.5", # erro de segurança da pagina
...
for ip in ips:
    try:
        ...
        if len(elemento_cont) >= 2:
            # pega o segundo elemento, não começa com 0 igual no array e sim no 1
            segundo_elemento = elemento_cont[2]
